...
Only four clips are currently exported: `Idle_Loop`, `Walk_Loop`, `Jog_Fwd_Loop` and `Sprint_Loop`. No paid tier is included. These are existing authored animations, not procedurally generated replacements; motion capture provenance is not asserted.
