...
- Follow the implementation stages in `docs/roadmap.md`. The action laboratory, off-ball experiment, squad training and Docker-first workflow are authorized. Do not treat historical source-document proposals as authorization for financial deployment or license selection.
