...
Updated: 2026-09-21. Status describes implementation, not final gameplay approval. Each increment must remain playable and retain its relevant automated checks. Architectural decisions belong in [ADRs](adr/README.md).
